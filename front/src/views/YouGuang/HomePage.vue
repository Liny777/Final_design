  ...
  <el-row>
    <el-row>
      <el-col :span="24" style="height:100%">
        <el-carousel :interval="5000" arrow="always" :height="dataHeight">
    ...
    <el-row>
      <el-col :span="12" style="margin-top:80px">
        <div class="cube-container">
          ...
          <div class="cube initial-position">
            ...
            <img class="cube-face-image image-1" src="@/assets/Visulization/Path1.jpg" @click="pathdirect">

            <img class="cube-face-image image-2" src="@/assets/Visulization/Relation1.jpg" @click="relationdirect">

            <img class="cube-face-image image-3" src="@/assets/Visulization/Search1.jpg" @click="searchdirect">

            <img class="cube-face-image image-4" src="@/assets/Visulization/edge.jpg" @click="edgedirect">

            <img class="cube-face-image image-5" src="@/assets/Visulization/Path1.jpg" @click="pathdirect">

            <img class="cube-face-image image-6" src="@/assets/Visulization/Relation1.jpg" @click="relationdirect">

          </div>

        </div>

        <h2 class="text">Click the buttons below to rotate the cube</h2>

        <div class="image-buttons">

          <button class="show-image-1"><svg><rect x="0" y="0" fill="none" width="100%" height="100%" /></svg>路径分析功能</button>

          <button class="show-image-2"><svg><rect x="0" y="0" fill="none" width="100%" height="100%" /></svg>关联分析功能</button>

          <button class="show-image-3"><svg><rect x="0" y="0" fill="none" width="100%" height="100%" /></svg>节点搜索功能</button>

          <button class="show-image-4"><svg><rect x="0" y="0" fill="none" width="100%" height="100%" /></svg>关系查询功能</button>

          <button class="show-image-5" />

          <button class="show-image-6" />
      ...
      <el-col :span="12" style="margin-top:80px">
        ...
        <el-row>
          <el-col :span="8" style="height: 540px;border-style:solid;border-width:1px;background-color: #FFFFFF">
...
export default {
  ...
  data() {
    return {
      ...
      imgList: [
        {
          name: '1',
          src: require('@/assets/Home/path.png'),
          title: 'path'
        },
        {
          name: '2',
          src: require('@/assets/Home/relation.png'),
          title: 'relation'
        },
        {
          name: '3',
          src: require('@/assets/Home/node.png'),
          title: 'node'
        },
        {
          name: '4',
          src: require('@/assets/Home/edge.png'),
          title: 'edge'
        }
      ],
      data: [{
  ...
  methods: {
    ...
    loadData() {
      ...
      pa['content'] = this.search_nodeid
      axios.post(url, pa).then((response) => {
    ...
    drawLine() {
      this.chart = echarts.init(document.getElementById('mychart'), 'infographic')
      var option = {
        title: {
          top: 'bottom',
          left: 'right'
