...
export const constantRoutes = [
  ...
  },
  {
    ...
    alwaysShow: true,
    name: 'Chart',
    meta: { title: 'Chart', icon: 'theme' },
    children: [
      {
        path: 'Visualization',
        component: () => import('@/views/YouGuang/HomePage'),
        name: 'Visualization',
        meta: { title: 'Visualization', icon: 'user', affix: true }
      },
      {
        path: 'test',
      ...
      {
        path: 'MainPage',
        component: () => import('@/views/YouGuang/MainPage'),
        name: 'MainPage',
        meta: { title: 'MainPage', icon: 'user' },
        hidden: true
      },
      {
        path: 'intro',
        component: () => import('@/views/YouGuang/intro'),
        name: 'intro',
        meta: { title: 'intro', icon: 'user' }
        // hidden: true
      }
    ]
  },
